...
class KeyPair{
    constructor(privateKey, publicKey) {// takes arguments and updates the class properties of THAT object. THIS is used to point to that particulart object jisse change kar rhe h at the moment.
